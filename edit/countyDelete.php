...
<!DOCTYPE html>
	...
	<body>
		...
		<div class="form">
			...
			{
				$ID = $_GET["delete"];
				$query = "DELETE FROM COUNTY where CountyID ='".$ID."'"; 
				...
				header("Location: http://corsair.cs.iupui.edu:24471/project/existCounty.php"); 
			}
			else
			{
				?>
				...
				<form name="form" method="post" action=""> 
					...
					<input name="id" type="hidden" value="<?php echo $row['CountyID'];?>" />

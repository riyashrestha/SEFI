	...
	<body>
		...
		<div class="form">
			...
			if(isset($_POST['new']) && $_POST['new']==1)
			{
				...
				$update = "UPDATE PROJECT_GRADE_LEVEL set LevelName = '$name', Active  = '$active' where GradeLevelID = '".$ID."'";

				mysql_query($update) or die(mysql_error());

				$status = "Record Updated Successfully. </br></br>

				<a href='http://corsair.cs.iupui.edu:24471/project/existGradeLevel.php'>View Updated Record</a>";
			...
			else
			{
				...
				<form name="form" method="post" action=""> 
					...
					<input name="id" type="hidden" value="<?php echo $row['GradeLevelID'];?>" />
